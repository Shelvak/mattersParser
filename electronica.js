...
var rootNode = { Content: 'ELECTRONICA', Nodes: [] }
rootNode.Nodes[0] = { Content: '1°', Nodes: [], Collapsed: true }
rootNode.Nodes[0].Nodes[0] = { Content: 'Lunes', Nodes: [], Collapsed: true }
rootNode.Nodes[0].Nodes[0].Nodes[0] = { Content: 'Informática I' }
rootNode.Nodes[1] = { Content: '2°', Nodes: [], Collapsed: true }
rootNode.Nodes[1].Nodes[0] = { Content: 'Martes', Nodes: [], Collapsed: true }
rootNode.Nodes[1].Nodes[1] = { Content: 'Miércoles', Nodes: [], Collapsed: true }
rootNode.Nodes[1].Nodes[2] = { Content: 'Jueves', Nodes: [], Collapsed: true }
rootNode.Nodes[1].Nodes[0].Nodes[0] = { Content: 'Sistemas de Representación' }
rootNode.Nodes[1].Nodes[0].Nodes[1] = { Content: 'Analisis de Señales y Sistemas' }
rootNode.Nodes[1].Nodes[1].Nodes[0] = { Content: 'Informática II' }
rootNode.Nodes[1].Nodes[1].Nodes[1] = { Content: 'Física Electrónica' }
rootNode.Nodes[1].Nodes[2].Nodes[0] = { Content: 'Quimica General' }
...
rootNode.Nodes[2].Nodes[0].Nodes[0] = { Content: 'Teoria de Circuitos I' }
rootNode.Nodes[2].Nodes[0].Nodes[1] = { Content: 'Dispositivos Electrónicos' }
rootNode.Nodes[2].Nodes[0].Nodes[2] = { Content: 'Seguridad, Higiene y Medio Ambiente' }
rootNode.Nodes[2].Nodes[1].Nodes[0] = { Content: 'Medios de Enlace' }
rootNode.Nodes[2].Nodes[2].Nodes[0] = { Content: 'Electrónica Aplicada I' }
rootNode.Nodes[2].Nodes[3].Nodes[0] = { Content: 'Ténicas Digitales I' }
rootNode.Nodes[2].Nodes[4].Nodes[0] = { Content: '???' }
...
rootNode.Nodes[3].Nodes[0].Nodes[0] = { Content: 'Máquinas e Instalaciones Eléctricas' }
rootNode.Nodes[3].Nodes[1].Nodes[0] = { Content: 'Medidas Electrónicas I' }
rootNode.Nodes[3].Nodes[2].Nodes[0] = { Content: 'Electrónica Aplicada II' }
rootNode.Nodes[3].Nodes[3].Nodes[0] = { Content: 'Teoria de Circuitos II' }
rootNode.Nodes[3].Nodes[3].Nodes[1] = { Content: 'Técnicas Digitales II' }
rootNode.Nodes[3].Nodes[4].Nodes[0] = { Content: '???' }
...
rootNode.Nodes[4].Nodes[4] = { Content: 'Viernes', Nodes: [], Collapsed: true }
rootNode.Nodes[4].Nodes[0].Nodes[0] = { Content: 'Electrónica de Potencia' }
rootNode.Nodes[4].Nodes[1].Nodes[0] = { Content: 'Medidas Electrónicas II' }
rootNode.Nodes[4].Nodes[2].Nodes[0] = { Content: 'Electrónica Aplicada III' }
rootNode.Nodes[4].Nodes[2].Nodes[1] = { Content: 'Organización Industrial' }
rootNode.Nodes[4].Nodes[3].Nodes[0] = { Content: 'Técnicas Digitales III' }
rootNode.Nodes[4].Nodes[3].Nodes[1] = { Content: 'Tecnología Electrónica' }
rootNode.Nodes[4].Nodes[4].Nodes[0] = { Content: 'Sistemas de Control' }
rootNode.Nodes[5] = { Content: '6°', Nodes: [], Collapsed: true }
rootNode.Nodes[5].Nodes[0] = { Content: 'Lunes', Nodes: [], Collapsed: true }
rootNode.Nodes[5].Nodes[1] = { Content: 'Martes', Nodes: [], Collapsed: true }
rootNode.Nodes[5].Nodes[2] = { Content: 'Miércoles', Nodes: [], Collapsed: true }
rootNode.Nodes[5].Nodes[3] = { Content: 'Jueves', Nodes: [], Collapsed: true }
rootNode.Nodes[5].Nodes[4] = { Content: 'Viernes', Nodes: [], Collapsed: true }
rootNode.Nodes[5].Nodes[0].Nodes[0] = { Content: 'Control de Procesos (Elec)' }
rootNode.Nodes[5].Nodes[0].Nodes[1] = { Content: 'Electrónica Industrial (Elec)' }
rootNode.Nodes[5].Nodes[1].Nodes[0] = { Content: 'Sistemas de Televisión (Elec)' }
rootNode.Nodes[5].Nodes[2].Nodes[0] = { Content: 'Antenas y Propagación de ondas electromagnéticas (Elec)' }
rootNode.Nodes[5].Nodes[2].Nodes[1] = { Content: 'Sistemas de Sonido (Elec)' }
rootNode.Nodes[5].Nodes[3].Nodes[0] = { Content: 'Técnicas Digitales IV (Elec)' }
rootNode.Nodes[5].Nodes[3].Nodes[1] = { Content: 'Proyecto Final' }
rootNode.Nodes[5].Nodes[4].Nodes[0] = { Content: 'Sistemas de Comunicaciones II (Elec)' }
rootNode.Nodes[5].Nodes[4].Nodes[1] = { Content: 'Sistemas de Comunicaciones III (Elec)' }
rootNode.Nodes[5].Nodes[4].Nodes[2] = { Content: 'Procesamiento Digital de Imágenes (Elec)' }
rootNode.Nodes[5].Nodes[4].Nodes[3] = { Content: 'Bioelectrónica (Elec)' }
